...
## Installation:
1. Download from npm:
`npm install dobarg-jalali-date-picker --save`  
2. import the `DpDatePickerModule` module in typescript (.ts) or es6 files like below:  
 `import {DpDatePickerModule} from 'dobarg-jalali-date-picker';`  
...
import {DatePickerComponent} from 'dobarg-jalali-date-picker';
